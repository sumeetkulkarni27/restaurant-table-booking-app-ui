...
const serverUrl='https://restaurant-table-app-api-csdnd5badfh9a3cn.austriaeast-01.azurewebsites.net/api';
...
export const environment: EnvironmentConfiguration = {
  ...
  adb2cConfig: {
    ...
    apiEndpointUrl: 'https://restaurant-table-app-api-csdnd5badfh9a3cn.austriaeast-01.azurewebsites.net/api/Reservation'
  },
